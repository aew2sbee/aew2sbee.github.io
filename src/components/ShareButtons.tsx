    ...
    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-6">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="hidden md:flex flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 items-center justify-center gap-2"
        >
